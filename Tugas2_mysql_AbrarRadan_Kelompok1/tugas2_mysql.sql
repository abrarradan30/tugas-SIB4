SOAL 2.1
1. Tampilkan seluruh data produk diurutkan berdasarkan harga jual mulai dari yang yang termahal
...
3. Tampilkan kode,nama,stok dari table produk yang stoknya hanya 4
...
5. Tampilkan kode,nama,tmp_lahir,tgl_lahir dari pelanggan diurutkan dari yang paling muda
usianya
...
4. Tampilkan data pelanggan mulai dari yang muda
